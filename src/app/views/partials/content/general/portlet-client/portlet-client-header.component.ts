...
@Component({
  selector: 'kt-portlet-client-header',
  styleUrls: ['portlet-client-header.component.scss'],
  template: `
...
export class PortletClientHeaderComponent implements OnInit, AfterViewInit, OnDestroy {
  // Public properties
