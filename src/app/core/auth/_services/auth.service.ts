...
import { QueryParamsModel, QueryResultsModel, LocalStoreService } from '../../_base/crud';
...
export class AuthService {
    ...
    getUser(): any {
        return this.localStoreService.getItem('token');
      }
    
      setUser(token: any) {
        this.localStoreService.setItem('token', token);
      }
